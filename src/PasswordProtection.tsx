...
export default function PasswordProtection({ onAuthenticated, onBack }: { onAuthenticated: () => void, onBack: () => void }) {
  ...
  return (
    ...
    >
      {/* NAV */}
      <nav className="fixed top-0 left-0 right-0 z-[500] h-[68px] flex items-center justify-between px-6 md:px-12 border-b border-[var(--bdr)] bg-[rgba(246,247,249,0.82)] backdrop-blur-[22px]">
        <button
          onClick={onBack}
